...
function Footer() {
    return ( 
        <footer style={{borderColor: "rgb(240, 240, 240)"}}>
        <div className='container border-top mt-5'>
          ...
          <p>
            ...
            investors. KYC is one time exercise while dealing in securities markets - once KYC is done through a SEBI registered intermediary (broker, DP, Mutual Fund etc.), you need not undergo the same process again when you approach another intermediary." Dear Investor, if you are subscribing to an IPO, there is no need to issue a cheque. Please write the Bank account number and sign the IPO application form to authorize your bank to make payment in case of allotment. In case of non allotment the funds will remain in your bank account. As a business we don't give stock tips, and have not authorized anyone to trade on behalf of others. If you find anyone
            claiming to be part of Zerodha and offering such services, please
            create a ticket here.
            </p>
            </div>

            <div className='mt-5 link-no-underline text-muted'  >
                <div className='d-flex  justify-content-center flex-wrap gap-4 
                '>
                <a href="#" className="text-dark text-decoration-none">NSE</a>
                <a href="#" className="text-dark text-decoration-none">BSE</a>
                <a href="#" className="text-dark text-decoration-none">MCX</a>
                <a href="#" className="text-dark text-decoration-none">Terms & conditions</a>
                <a href="#" className="text-dark text-decoration-none">Policies & procedures</a>
                <a href="#" className="text-dark text-decoration-none">Privacy policy</a>
                <a href="#" className="text-dark text-decoration-none">Disclosure</a>
                </div>
            </div>
        </div>
        </footer>
